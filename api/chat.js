export default async function handler(req, res) {
  ...
  try {
    ...
    // OpenAI Responses API-д өгөх input
    const input = [
      ...conversationHistory,
      {
        role: "user",
...
- Personal project:
  https://naidandorj.github.io/My_new_web/
- Gamshigyn medeelel:
  https://gamshigyn-medeelel.vercel.app/
...
3. Мэдэхгүй мэдээлэл байвал:
   "Энэ мэдээлэл одоогоор миний өгөгдөлд байхгүй байна."
   гэж хэл.
...
7. Хэрэглэгч "Чи хэн бэ?" гэж асуувал:
   "Би Naidaa AI. Нямжавын Найдандоржийн хувийн вебийн AI туслах."
   гэж тайлбарла.
